...
See [address_table](https://github.com/OffchainLabs/arbitrum-interop-quickstart/tree/final-review/packages/address_table) for a demo of client-side interactions with the address table.
