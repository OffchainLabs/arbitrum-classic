...
See [address_table](https://github.com/OffchainLabs/arbitrum-tutorials/packages/address_table) for a demo of client-side interactions with the address table.
