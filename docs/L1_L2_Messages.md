...
Arbitrum offers several ways for an Ethereum transaction to send a message to Arbitrum ([see "L2 Messages"](../packages/arb-os/doc/DataFormats.md)); however, the generally recommended method to use for direct L1 to L2 communication is via retryable tickets.
