...
See [Greeter](https://github.com/OffchainLabs/arbitrum-interop-quickstart/tree/final-review/packages/greeter) for a simple demo illustrating the use of retryable tickets.
...
See [outbox-execute](https://github.com/OffchainLabs/arbitrum-interop-quickstart/tree/final-review/packages/outbox-execute) for client side interactions with the outbox using the [arb-ts](https://arb-ts-docs.netlify.app/) library.
