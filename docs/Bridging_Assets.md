...
See [token-deposit](https://github.com/OffchainLabs/arbitrum-interop-quickstart/tree/final-review/packages/token_deposit) and [token-withdraw](https://github.com/OffchainLabs/arbitrum-interop-quickstart/tree/final-review/packages/token_withdraw) for demos of interacting with the bridge architecture via [arb-ts](https://arb-ts-docs.netlify.app/).
