...
| 0x80                                            | ecrecover     | Pop four values off the Data Stack, the first two representing the signature, third the message, and fourth the recovery ID, push two values the first being 1 if the message signature pair is valid and 0 otherwise, and the second containing the Ethereum address of the pair, or 0 if it is not valid.                                                        | 9999        |
