...
| 0x80                                            | ecrecover     | Pop seven values off the Data Stack, the first two representing the signature, third through sixth the message, and seventh the recovery ID, push two values representing the corresponding public key for the message signature pair.                                                                                                                             | 10          |
