...
//func TestTransferConstructor(t *testing.T) {
...
//	}
//
//	t.Log("transfer1Balance", transfer1Balance)
//	t.Log("transfer2Balance", transfer2Balance)
//	t.Log("senderBalance", senderBalance)
//}
