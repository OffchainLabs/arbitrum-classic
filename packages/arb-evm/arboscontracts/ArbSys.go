...
// GetStorageGasAvailable is a paid mutator transaction binding the contract method 0xa94597ff.
//
// Solidity: function getStorageGasAvailable() returns(uint256)
func (_ArbSys *ArbSysTransactor) GetStorageGasAvailable(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbSys.contract.Transact(opts, "getStorageGasAvailable")
}

// GetStorageGasAvailable is a paid mutator transaction binding the contract method 0xa94597ff.
//
// Solidity: function getStorageGasAvailable() returns(uint256)
func (_ArbSys *ArbSysSession) GetStorageGasAvailable() (*types.Transaction, error) {
	return _ArbSys.Contract.GetStorageGasAvailable(&_ArbSys.TransactOpts)
}

// GetStorageGasAvailable is a paid mutator transaction binding the contract method 0xa94597ff.
//
// Solidity: function getStorageGasAvailable() returns(uint256)
func (_ArbSys *ArbSysTransactorSession) GetStorageGasAvailable() (*types.Transaction, error) {
	return _ArbSys.Contract.GetStorageGasAvailable(&_ArbSys.TransactOpts)
}
