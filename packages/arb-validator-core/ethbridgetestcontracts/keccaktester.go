...
const KeccakTesterABI = "[{\"constant\":true,\"inputs\":[{\"internalType\":\"uint256[25]\",\"name\":\"input\",\"type\":\"uint256[25]\"}],\"name\":\"keccakF\",\"outputs\":[{\"internalType\":\"uint256[25]\",\"name\":\"\",\"type\":\"uint256[25]\"}],\"payable\":false,\"stateMutability\":\"pure\",\"type\":\"function\"}]"
...
func (_KeccakTester *KeccakTesterCaller) KeccakF(opts *bind.CallOpts, input [25]*big.Int) ([25]*big.Int, error) {
	var (
		ret0 = new([25]*big.Int)
	)
	out := ret0
	err := _KeccakTester.contract.Call(opts, out, "keccakF", input)
	return *ret0, err
}
...
//
// Solidity: function keccakF(uint256[25] input) pure returns(uint256[25])
func (_KeccakTester *KeccakTesterSession) KeccakF(input [25]*big.Int) ([25]*big.Int, error) {
	return _KeccakTester.Contract.KeccakF(&_KeccakTester.CallOpts, input)
}

// KeccakF is a free data retrieval call binding the contract method 0xac90ed46.
//
// Solidity: function keccakF(uint256[25] input) pure returns(uint256[25])
func (_KeccakTester *KeccakTesterCallerSession) KeccakF(input [25]*big.Int) ([25]*big.Int, error) {
	return _KeccakTester.Contract.KeccakF(&_KeccakTester.CallOpts, input)
}
