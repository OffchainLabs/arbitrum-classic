...
IGNORED_ARCH=$ARCH_PREFIX/Value.sol:Value,$ARCH_PREFIX/Marshaling.sol:Marshaling,$ARCH_PREFIX/Hashing.sol:Hashing,$ARCH_PREFIX/Protocol.sol:Protocol,$ARCH_PREFIX/Machine.sol:Machine,$ARCH_PREFIX/IOneStepProof.sol:IOneStepProof,$ARCH_PREFIX/IOneStepProof.sol:IOneStepProof2,$ARCH_PREFIX/OneStepProofCommon.sol:OneStepProofCommon
