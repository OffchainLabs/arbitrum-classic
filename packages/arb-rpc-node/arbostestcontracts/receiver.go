...
var ReceiverMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"otherReciver\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[],\"name\":\"mutate\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"other\",\"outputs\":[{\"internalType\":\"contractReceiver2\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"test\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Bin: "",
}
...
// Receiver2MetaData contains all meta data concerning the Receiver2 contract.
var Receiver2MetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"mutate\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"test\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Bin: "",
}

// Receiver2ABI is the input ABI used to generate the binding from.
// Deprecated: Use Receiver2MetaData.ABI instead.
var Receiver2ABI = Receiver2MetaData.ABI

// Receiver2Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use Receiver2MetaData.Bin instead.
var Receiver2Bin = Receiver2MetaData.Bin
...
func DeployReceiver2(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *Receiver2, error) {
	parsed, err := Receiver2MetaData.GetAbi()
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	if parsed == nil {
