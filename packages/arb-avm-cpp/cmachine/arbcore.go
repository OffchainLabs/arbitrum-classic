...
func (ac *ArbCore) CheckpointMinMessageIndex(messageIndex *big.Int) error {
	messageIndexData := math.U256Bytes(messageIndex)
	success := C.arbCoreCheckpointMinMessageIndex(ac.c, unsafeDataPointer(messageIndexData))
	if success == 0 {
