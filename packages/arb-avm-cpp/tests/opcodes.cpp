...
TEST_CASE("OPCODE: BLAKE2BF opcode") {
    SECTION("Test Vector 4") {
        Buffer input = Buffer::fromData(hexToVec(""));
        Buffer output = Buffer::fromData(hexToVec("ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923"));
        MachineState m;
        m.stack.push(input);
        m.runOp(OpCode::BLAKE2BF);
        REQUIRE(m.stack[0] == value{output});
        REQUIRE(m.stack.stacksize() == 1);
    }
    SECTION("Test Vector 5") {
        Buffer input = Buffer::fromData(hexToVec(""));
        Buffer output = Buffer::fromData(hexToVec("ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923"));
        MachineState m;
        m.stack.push(input);
    ...
    SECTION("Test Vector 6") {
        Buffer input = Buffer::fromData(hexToVec(""));
        Buffer output = Buffer::fromData(hexToVec("75ab69d3190a562c51aef8d88f1c2775876944407270c42c9844252c26d2875298743e7f6d5ea2f2d3e8d226039cd31b4e426ac4f2d3d666a610c2116fde4735"));
        MachineState m;
        m.stack.push(input);
        m.runOp(OpCode::BLAKE2BF);
        REQUIRE(m.stack[0] == value{output});
    ...
    SECTION("Test Vector 7") {
        Buffer input = Buffer::fromData(hexToVec(""));
        Buffer output = Buffer::fromData(hexToVec("b63a380cb2897d521994a85234ee2c181b5f844d2c624c002677e9703449d2fba551b3a8333bcdf5f2f7e08993d53923de3d64fcc68c034e717b9293fed7a421"));
        MachineState m;
        m.stack.push(input);
        m.runOp(OpCode::BLAKE2BF);
        REQUIRE(m.stack[0] == value{output});
    ...
    /* Note: TestVector 8 uses 0xffffffff rounds, which we don't support */
}
