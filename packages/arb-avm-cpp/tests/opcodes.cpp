...
TEST_CASE("OPCODE: BLAKE2BF opcode") {
    struct BLAKE2BFCase {
        ...
        std::vector<unsigned char> output_expected;
    };
    std::vector<BLAKE2BFCase> cases = {
        {/* Test Vector 4 */
         hexToVec(
         ...
         hexToVec(
             ...
             "7d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd400992"
             "3")},
        {/* Test Vector 5 */
         hexToVec(
             "0000000c48c9bdf267e6096a3ba7ca8485ae67bb2bf894fe72f36e3cf1361d5f"
        ...
        {/* Test Vector 6 */
         ...
         hexToVec(
             ...
             "98743e7f6d5ea2f2d3e8d226039cd31b4e426ac4f2d3d666a610c2116fde473"
             "5")},
        {/* Test Vector 7 */
         hexToVec(
         ...
         hexToVec(
             ...
             "a551b3a8333bcdf5f2f7e08993d53923de3d64fcc68c034e717b9293fed7a42"
             "1")} /* Note: TestVector 8 uses 0xffffffff rounds, which we don't
                      support */
    };
    SECTION("Hash is correct") {
        for (const auto& test_case : cases) {
            Buffer input = Buffer::fromData(test_case.input_data);
            Buffer output = Buffer::fromData(test_case.output_expected);
            MachineState m;
            m.stack.push(input);
