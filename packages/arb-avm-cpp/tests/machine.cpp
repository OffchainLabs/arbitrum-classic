...
TEST_CASE("Machine hash") {
    ...
    REQUIRE(pcHash == uint256_t("7082916098557059056596650196761542028147454465"
                                "4293735218754956639079870976076"));
    ...
    REQUIRE(registerHash == uint256_t("4251290975118555612292311539115420848775"
                                      "2310613213055089416300774052282720344"));
    REQUIRE(staticHash == uint256_t("660731764326055774085312268439783157981534"
                                    "31986110385861317929769378991412316"));
