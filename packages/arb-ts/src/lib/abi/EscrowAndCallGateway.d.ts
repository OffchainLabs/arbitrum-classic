...
interface EscrowAndCallGatewayInterface extends ethers.utils.Interface {
  functions: {
...
export class EscrowAndCallGateway extends BaseContract {
  ...
  interface: EscrowAndCallGatewayInterface
