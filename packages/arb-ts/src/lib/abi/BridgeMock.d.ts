...
interface BridgeMockInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: 'deliverMessageToInboxTest',
    values: [
      BigNumberish,
      string,
      BigNumberish,
...
export class BridgeMock extends BaseContract {
