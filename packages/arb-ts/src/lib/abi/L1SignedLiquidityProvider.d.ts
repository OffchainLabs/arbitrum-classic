...
interface L1SignedLiquidityProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class L1SignedLiquidityProvider extends Contract {
  ...
  interface: L1SignedLiquidityProviderInterface
