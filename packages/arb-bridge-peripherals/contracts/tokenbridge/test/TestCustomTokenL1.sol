...
contract TestCustomTokenL1 is ICustomToken, Context, IERC20 {
    ...
    // balance Of and transfer From override their implementations in ICustomToken
    function balanceOf(address account)
        public
        view
        override(ICustomToken, IERC20)
        returns (uint256)
    {
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override(ICustomToken, IERC20) returns (bool) {
