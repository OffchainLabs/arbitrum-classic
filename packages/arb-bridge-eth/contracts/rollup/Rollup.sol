...
import "./INode.sol";
// CHRIS: check all imports of Node - we should be importing an interface
import "./Node.sol";
...
contract Rollup is Proxy, RollupBase {
    ...
    function createInitialNode(bytes32 _machineHash) private returns (Node memory) {
        ...
        // CHRIS: we remove below, decide if we should keep
