...
FROM offchainlabs/cpp-base:0.3.5 as arb-avm-cpp
...
FROM offchainlabs/backend-base:0.3.5 as arb-validator-builder
...
FROM offchainlabs/cpp-base:0.3.5 as arb-validator
# Export binary
