...
func (v *Validator) removeOldStakers(ctx context.Context, dontRemoveSelf bool) (*ethbridge.ArbTransaction, error) {
...
func (v *Validator) resolveTimedOutChallenges(ctx context.Context) (*ethbridge.ArbTransaction, error) {
