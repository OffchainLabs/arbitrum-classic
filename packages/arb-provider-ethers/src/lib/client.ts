...
function logValToLog(
    ...
    return {
        ...
        address: ethers.utils.hexlify(
            (value.get(0) as ArbValue.IntValue).bignum
        ),
            ...
            .map(rawTopic =>
                ethers.utils.hexZeroPad(
                    ethers.utils.hexlify(
                        (rawTopic as ArbValue.IntValue).bignum
                    ),
                    32
                )
            ),
...
export class TxCall {
    ...
    constructor(value: ArbValue.TupleValue) {
        ...
        this.data = ArbValue.bytestackToBytes(
            value.get(1) as ArbValue.TupleValue
        );
    }
...
export class TxMessage {
    ...
    constructor(value: ArbValue.TupleValue) {
        ...
        this.data = ArbValue.bytestackToBytes(
            value.get(3) as ArbValue.TupleValue
        );
    }
...
export class ContractTxMessage {
    ...
    constructor(value: ArbValue.TupleValue) {
        ...
        this.data = ArbValue.bytestackToBytes(
            value.get(2) as ArbValue.TupleValue
        );
    }
...
export class EVMReturn {
    ...
    constructor(value: ArbValue.TupleValue) {
        this.bridgeData = new EthBridgeMessage(
            value.get(0) as ArbValue.TupleValue
        );
