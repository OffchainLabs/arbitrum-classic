...
func (c *EthArbAuthClient) DeployChallengeTester(address common.Address) (arbbridge.ChallengeTester, error) {
	return deployChallengeTester(address.ToEthAddress(), c.client, c.auth)
}
