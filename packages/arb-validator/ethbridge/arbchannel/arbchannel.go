...
func (_ArbChannel *ArbChannelTransactor) Init(opts *bind.TransactOpts, _vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _maxArbGas uint64, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.contract.Transact(opts, "init", _vmState, _gracePeriod, _maxExecutionSteps, _maxArbGas, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}

// Init is a paid mutator transaction binding the contract method 0x01c028bc.
//
// Solidity: function init(bytes32 _vmState, uint32 _gracePeriod, uint32 _maxExecutionSteps, uint64 _maxArbGas, uint128 _escrowRequired, address _owner, address _challengeLauncherAddress, address _globalInboxAddress, address[] _validatorKeys) returns()
func (_ArbChannel *ArbChannelSession) Init(_vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _maxArbGas uint64, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.Contract.Init(&_ArbChannel.TransactOpts, _vmState, _gracePeriod, _maxExecutionSteps, _maxArbGas, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}

// Init is a paid mutator transaction binding the contract method 0x01c028bc.
//
// Solidity: function init(bytes32 _vmState, uint32 _gracePeriod, uint32 _maxExecutionSteps, uint64 _maxArbGas, uint128 _escrowRequired, address _owner, address _challengeLauncherAddress, address _globalInboxAddress, address[] _validatorKeys) returns()
func (_ArbChannel *ArbChannelTransactorSession) Init(_vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _maxArbGas uint64, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.Contract.Init(&_ArbChannel.TransactOpts, _vmState, _gracePeriod, _maxExecutionSteps, _maxArbGas, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}

// Init0 is a paid mutator transaction binding the contract method 0x7588110b.
//
...
func (_ArbChannel *ArbChannelTransactor) Init0(opts *bind.TransactOpts, _vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.contract.Transact(opts, "init0", _vmState, _gracePeriod, _maxExecutionSteps, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}

// Init0 is a paid mutator transaction binding the contract method 0x7588110b.
//
// Solidity: function init(bytes32 _vmState, uint32 _gracePeriod, uint32 _maxExecutionSteps, uint128 _escrowRequired, address _owner, address _challengeLauncherAddress, address _globalInboxAddress, address[] _validatorKeys) returns()
func (_ArbChannel *ArbChannelSession) Init0(_vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.Contract.Init0(&_ArbChannel.TransactOpts, _vmState, _gracePeriod, _maxExecutionSteps, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}

// Init0 is a paid mutator transaction binding the contract method 0x7588110b.
//
// Solidity: function init(bytes32 _vmState, uint32 _gracePeriod, uint32 _maxExecutionSteps, uint128 _escrowRequired, address _owner, address _challengeLauncherAddress, address _globalInboxAddress, address[] _validatorKeys) returns()
func (_ArbChannel *ArbChannelTransactorSession) Init0(_vmState [32]byte, _gracePeriod uint32, _maxExecutionSteps uint32, _escrowRequired *big.Int, _owner common.Address, _challengeLauncherAddress common.Address, _globalInboxAddress common.Address, _validatorKeys []common.Address) (*types.Transaction, error) {
	return _ArbChannel.Contract.Init0(&_ArbChannel.TransactOpts, _vmState, _gracePeriod, _maxExecutionSteps, _escrowRequired, _owner, _challengeLauncherAddress, _globalInboxAddress, _validatorKeys)
}
