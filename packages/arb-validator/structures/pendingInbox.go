...
func (ms *MessageStack) MarshalForCheckpoint(ctx checkpointing.CheckpointContext) *PendingInboxBuf {
...
func (buf *PendingInboxBuf) UnmarshalFromCheckpoint(ctx checkpointing.RestoreContext) (*MessageStack, error) {
	ret := NewMessageStack()
