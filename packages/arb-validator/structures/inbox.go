...
func (b *Inbox) GenerateBisection(startIndex, segments, count uint64) ([]common.Hash, error) {
...
func (b *Inbox) String() string {
	return fmt.Sprintf("%v", b.hashes)
}

func (b *Inbox) AsValue() value.TupleValue {
	return b.value
}

func (b *Inbox) Hash() common.Hash {
