...
type PendingInboxBuf struct {
	...
	Items                [][]byte             `protobuf:"bytes,21,rep,name=items,proto3" json:"items,omitempty"`
...
type PendingInboxCkpBuf struct {
	TopCount             *value.BigIntegerBuf `protobuf:"bytes,1,opt,name=topCount,proto3" json:"topCount,omitempty"`
...
func (m *PendingInboxCkpBuf) Reset()         { *m = PendingInboxCkpBuf{} }
func (m *PendingInboxCkpBuf) String() string { return proto.CompactTextString(m) }
func (*PendingInboxCkpBuf) ProtoMessage()    {}
func (*PendingInboxCkpBuf) Descriptor() ([]byte, []int) {
	return fileDescriptor_66ea84bc81126bff, []int{7}
}

func (m *PendingInboxCkpBuf) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PendingInboxCkpBuf.Unmarshal(m, b)
}
func (m *PendingInboxCkpBuf) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PendingInboxCkpBuf.Marshal(b, m, deterministic)
}
func (m *PendingInboxCkpBuf) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PendingInboxCkpBuf.Merge(m, src)
}
func (m *PendingInboxCkpBuf) XXX_Size() int {
	return xxx_messageInfo_PendingInboxCkpBuf.Size(m)
}
func (m *PendingInboxCkpBuf) XXX_DiscardUnknown() {
	xxx_messageInfo_PendingInboxCkpBuf.DiscardUnknown(m)
}

var xxx_messageInfo_PendingInboxCkpBuf proto.InternalMessageInfo

func (m *PendingInboxCkpBuf) GetTopCount() *value.BigIntegerBuf {
	if m != nil {
		return m.TopCount
	}
	return nil
...
func (m *PendingInboxCkpBuf) GetItemHashes() []*value.HashBuf {
	if m != nil {
		return m.ItemHashes
	}
	return nil
...
func (m *PendingInboxCkpBuf) GetHashOfRest() *value.HashBuf {
	if m != nil {
		return m.HashOfRest
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PendingInboxCkpBuf)(nil), "structures.PendingInboxCkpBuf")
}
...
var fileDescriptor_66ea84bc81126bff = []byte{
	...
	,
}
